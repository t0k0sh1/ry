...
| 04 | [制御構文](tutorial/04-control-flow.md) | if/else・case・while・for/range・break/continue |
...
| [制御構文](reference/control-flow.md) | if/else・case・while・for の完全な文法 |
| [関数・ラムダ・UFCS・演算子オーバーロード](reference/functions.md) | 関数定義の全形式 |
| [レコード・列挙型](reference/structs.md) | record 定義・enum 定義の完全な文法 |
